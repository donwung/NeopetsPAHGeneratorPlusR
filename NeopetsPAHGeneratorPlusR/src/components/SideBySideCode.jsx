...
const SideBySideCode = (props) => {
    ...
    useEffect(() => {
        const pastableString_stacked = generateCopyPastableHTML_stacked(props.data, props.settings)
        const pastableString_SBS = generateCopyPastableHTML_SBS(props.data, props.settings)
